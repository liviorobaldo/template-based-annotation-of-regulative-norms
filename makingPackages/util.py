...
def extract_sections_from_part(part_file, output_file=None):
    ...
    try:
        ...
        for anchor in section_anchors:
            ...
            while current and not (current.name in ['h2', 'h3', 'h4', 'h5', 'h6'] or current.find('a', id=lambda x: x and x.startswith('section-'))):
...
def _extract_section_hierarchy(section_anchor, soup):
    ...
    # Collect hierarchical content (reusing logic from extract_sections_with_hierarchy)
    hierarchy = {
        'main_content': '',
        'subsections': {}
    }
...
if __name__ == "__main__":
    ...
    part_file = current_dir + "/processed_acts/2021_17.xhtml"
    output_file = current_dir + "/outputs/2021_17_sections_hierarchy.json"
    ...
    # Original function for comparison (uncomment to use)
    # part_file = current_dir + "/packages/1989_41_part_1/acts/1989_41.xhtml"
    # output_file = current_dir + "/packages/1989_41_part_1/acts/1989_41_part_1_sections.json"
